...
public class API_Put_Product 
{
	...
	public void Verify_Response_Code() 
	{
		...
		String data = "name=Test_Unique_01&price=9.99";						 // "name" and "price" parameter values
		request.header("Content-Type", "application/x-www-form-urlencoded");
		request.header("Accept", "application/json");
		request.body(data);
		Response response = request.put("4");								// Put URL with Product "id" Parameter Value (Note: Before run this API, Get list of all prodcts and pass only existing unique product id)
